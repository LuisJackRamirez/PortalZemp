...
@section('title', 'Profesores Admin')

@section('content')
    @include('admin.menu_admin')

    <h1 class="text-center"> Administrador de profesores </h1>
        ...
        <table class="table table-hover mt-2 text-center">
            ...
            @foreach($profesores as $profesor)
                <tr>
                    ...
                    <td>
                        <a href="" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editModal{{$profesor->id}}">
